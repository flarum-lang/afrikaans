...
This language pack contains Afrikaans translations for Flarum (compatible with `2.0.0` or newer) and popular extensions. Full list of supported extensions is available below.
...
```console
composer require "flarum-lang/afrikaans:@dev"
```
